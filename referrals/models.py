...
class Task(models.Model):
    TASK_TYPE_CHOICES = (
        ('tg_channel', 'Подписка на Telegram канал'),
    )
    title = models.CharField(max_length=200)
    description = models.TextField()
    type = models.CharField(max_length=30, choices=TASK_TYPE_CHOICES)
...
class TaskCompletion(models.Model):
    ...
    task = models.ForeignKey('referrals.Task', on_delete=models.CASCADE)
