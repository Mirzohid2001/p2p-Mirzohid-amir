...
from .models import User, TonProcessedTx
...
@admin.register(TonProcessedTx)
class TonProcessedTxAdmin(admin.ModelAdmin):
    list_display = ('tx_hash', 'user', 'value', 'created')
    search_fields = ('tx_hash', 'user__username', 'user__telegram_id')